...
class CbrAppGeneralManager extends CI_Controller
{
    ...
    {
        // Mendapatkan data request, biasanya untuk DataTables
        ...
        $columns = array(
            ...
            1 => 'TAccCashBookReq_Header.CBReq_No', // Duplikat, mungkin kolom ke-2 adalah tampilan lain
            2 => 'Type',
            3 => 'Document_Date',
        ...
        $sql = "SELECT DISTINCT 
                ...
                AND (
                    (
                        A.AppvGeneralManager_By = '$username' AND A.IsAppvGeneralManager = 1 AND A.Status_AppvGeneralManager = 0
